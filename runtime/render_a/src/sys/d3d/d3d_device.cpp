...
//	D3D_CALL(m_pD3DDevice->SetRenderState(D3DRS_EDGEANTIALIAS, FALSE));
	...
	D3D_CALL(m_pD3DDevice->SetRenderState(D3DRS_ZWRITEENABLE, 1));
	...
	D3D_CALL(m_pD3DDevice->SetRenderState(D3DRS_SPECULARENABLE, 0));
	D3D_CALL(m_pD3DDevice->SetRenderState(D3DRS_SHADEMODE, D3DSHADE_GOURAUD));
	D3D_CALL(m_pD3DDevice->SetRenderState(D3DRS_DITHERENABLE, 1));
	D3D_CALL(m_pD3DDevice->SetRenderState(D3DRS_FILLMODE, g_CV_Wireframe ? D3DFILL_WIREFRAME : D3DFILL_SOLID));
	D3D_CALL(m_pD3DDevice->SetRenderState(D3DRS_ALPHABLENDENABLE, 0));
	D3D_CALL(m_pD3DDevice->SetRenderState(D3DRS_ALPHATESTENABLE, 0));
	...
	D3D_CALL(m_pD3DDevice->SetRenderState(D3DRS_COLORVERTEX, 0));
	D3D_CALL(m_pD3DDevice->SetRenderState(D3DRS_VERTEXBLEND, D3DVBF_DISABLE));
	D3D_CALL(m_pD3DDevice->SetRenderState(D3DRS_INDEXEDVERTEXBLENDENABLE, 0));
	D3D_CALL(m_pD3DDevice->SetRenderState(D3DRS_NORMALIZENORMALS,0));
	D3D_CALL(m_pD3DDevice->SetRenderState(D3DRS_CLIPPING, 1));
	...
	D3D_CALL(m_pD3DDevice->SetRenderState(D3DRS_LIGHTING,0));
