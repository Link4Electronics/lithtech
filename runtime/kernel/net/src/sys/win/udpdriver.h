...
public:
	...
	{ 
		pAddr[0] = (uint8)(m_RemoteAddr.sin_addr.s_addr & 0xFF);
		pAddr[1] = (uint8)((m_RemoteAddr.sin_addr.s_addr >> 8 ) & 0xFF);
		pAddr[2] = (uint8)((m_RemoteAddr.sin_addr.s_addr >> 16 ) & 0xFF);
		pAddr[3] = (uint8)((m_RemoteAddr.sin_addr.s_addr >> 24 ) & 0xFF);
